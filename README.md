...
Process **only orders from locations in the EU** (eu-west or eu-east) using a **AWS Step Functions** target (**OrderProcessing**). 
...
![image](https://user-images.githubusercontent.com/91480603/215528896-6b795989-e5e4-4f85-a983-6d38d27f7768.png)
